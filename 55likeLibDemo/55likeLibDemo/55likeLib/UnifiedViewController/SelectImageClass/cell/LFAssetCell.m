...
- (void)selectPhotoButtonClick {
    [self selectPhotoCell:!_selectPhotoButton.selected];
}
-(void)selectPhotoCell:(BOOL)aSelect{
    _selectPhotoButton.selected = aSelect;
    self.selectImageView.image = _selectPhotoButton.isSelected ? bundleImageNamed(self.photoSelImageName) : bundleImageNamed(self.photoDefImageName);
    ...
    if (self.didSelectPhotoBlock) {
        self.didSelectPhotoBlock(_selectPhotoButton.selected, self.model);
    }
}
