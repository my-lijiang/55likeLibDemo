...
////新增单选模式(只针对图片)
@property (nonatomic, assign) BOOL showRadioImage;   ///默认NO
///< 裁剪图片的尺寸
...
///单图
@property (nonatomic, copy) void (^didFinishPickingRadioImagesHandle)(UIImage * cropImages,UIImage *originalImages);
/** 视频 */
...
////单图处理
/**
 当选择器点击完成的时候，会执行回调（单图执行）
 @param picker 选择器
 @param cropImages 裁剪后的图
 @param originalImages 原图
 */
